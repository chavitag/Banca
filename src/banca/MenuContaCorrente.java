    ...
    public boolean menu(int opc) throws Exception {
        ...
        switch(opc) {
            case 1:
                ...
                autorizados=cc.listaAutorizados.values();
            ...
            case 2:
                ...
                entidad=cc.listaAutorizados.get(codigo);
                if (entidad==null) System.out.println("Entidade non rexistrada");
                    ...
                    if (Character.toLowerCase(choose)=='c') {
                        cc.listaAutorizados.remove(codigo);
            ...
            case 3:
                ...
                if (entidad==null) System.out.println("Entidade non rexistrada");
                    ...
                    dom=entidad.domiciliaciones.get(codigo);
                    if (dom==null) System.out.println("A domiciliacion non existe");
                    else {
                        entidad.domiciliaciones.remove(codigo);
                        AplicacionBanca.contas.update(cc);
                    }
                }
                break;
            case 4:
                ...
                if (entidad==null) {
                    ...
                    cc.listaAutorizados.put(codigo,entidad);
                } else {
                ...
                if (entidad.domiciliaciones.get(codigo)!=null) {
                    System.out.println("Ya domiciliado");
                } else {
                    dom=new Domiciliacion(codigo,concepto);
                    entidad.domiciliaciones.put(codigo,dom);
                    AplicacionBanca.contas.update(cc);
                }
                break;
            case 5:
